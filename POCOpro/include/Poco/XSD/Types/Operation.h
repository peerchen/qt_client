...
// Operation.h
//
// $Id: //poco/1.7/XSD/Types/include/Poco/XSD/Types/Operation.h#2 $
//
// Library: XSD/Types
// Package: WSDL
// Module:  Operation
...
private:
	...
	std::vector<std::string> _parameterOrder;
};
...
inline const std::vector<std::string>& Operation::parameterOrder() const
{

...
//
// $Id: //poco/1.7/UPnP/ServiceDesc/include/Poco/UPnP/ServiceDesc/ServiceContentHandler.h#1 $
//
...
private:
	...
	Poco::Int64 getCharactersAsInt() const;
	Poco::Int64 getCharactersAsInt(Poco::Int64 def) const;

...
// PizzeriaClient.cpp
//
// $Id: //poco/1.7/RemotingNG/samples/PizzeriaClientWS/src/PizzeriaClient.cpp#2 $
//
...
int main(int argc, char** argv)
{
	try
	{
		...
		Pizzeria::IPizzaDeliveryService::Ptr pPizzeria = Pizzeria::PizzaDeliveryServiceClientHelper::find("http://localhost:8080/soap/Pizzeria.PizzaDeliveryService/ThePizzeria");

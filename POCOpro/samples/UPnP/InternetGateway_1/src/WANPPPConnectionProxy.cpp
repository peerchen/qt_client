...
WANPPPConnectionProxy::WANPPPConnectionProxy(const Poco::RemotingNG::Identifiable::ObjectId& oid):
...
WANPPPConnectionProxy::~WANPPPConnectionProxy()
{
	if (_pEventListener)
	{
		try
...
void WANPPPConnectionProxy::addPortMapping(const std::string& newRemoteHost, Poco::UInt16 newExternalPort, const std::string& newProtocol, Poco::UInt16 newInternalPort, const std::string& newInternalClient, bool newEnabled, const std::string& newPortMappingDescription, Poco::UInt32 newLeaseDuration)
{
...
void WANPPPConnectionProxy::configureConnection(const std::string& newUserName, const std::string& newPassword)
{
	remoting__staticInitBegin(REMOTING__NAMES);
	...
	Poco::RemotingNG::TypeSerializer<std::string >::serialize(REMOTING__NAMES[2], newPassword, remoting__ser);
	remoting__ser.serializeMessageEnd(REMOTING__NAMES[0], Poco::RemotingNG::SerializerBase::MESSAGE_REQUEST);
	remoting__ser.popProperty(Poco::RemotingNG::SerializerBase::PROP_NAMESPACE);
	Poco::RemotingNG::Deserializer& remoting__deser = remoting__trans.sendRequest(remoting__objectId(), remoting__typeId(), REMOTING__NAMES[0], Poco::RemotingNG::SerializerBase::MESSAGE_REQUEST);
	remoting__deser.pushProperty(Poco::RemotingNG::SerializerBase::PROP_NAMESPACE, DEFAULT_NS);
...
void WANPPPConnectionProxy::deletePortMapping(const std::string& newRemoteHost, Poco::UInt16 newExternalPort, const std::string& newProtocol)
{
	remoting__staticInitBegin(REMOTING__NAMES);
...
void WANPPPConnectionProxy::forceTermination()
{
	remoting__staticInitBegin(REMOTING__NAMES);
...
void WANPPPConnectionProxy::getAutoDisconnectTime(Poco::UInt32& newAutoDisconnectTime)
{
	remoting__staticInitBegin(REMOTING__NAMES);
...
void WANPPPConnectionProxy::getConnectionTypeInfo(std::string& newConnectionType, std::string& newPossibleConnectionTypes)
{
	remoting__staticInitBegin(REMOTING__NAMES);
...
void WANPPPConnectionProxy::getExternalIPAddress(std::string& newExternalIPAddress)
{
	remoting__staticInitBegin(REMOTING__NAMES);
...
void WANPPPConnectionProxy::getGenericPortMappingEntry(Poco::UInt16 newPortMappingIndex, std::string& newRemoteHost, Poco::UInt16& newExternalPort, std::string& newProtocol, Poco::UInt16& newInternalPort, std::string& newInternalClient, bool& newEnabled, std::string& newPortMappingDescription, Poco::UInt32& newLeaseDuration)
{
	remoting__staticInitBegin(REMOTING__NAMES);
...
void WANPPPConnectionProxy::getIdleDisconnectTime(Poco::UInt32& newIdleDisconnectTime)
{
	remoting__staticInitBegin(REMOTING__NAMES);
...
void WANPPPConnectionProxy::getLinkLayerMaxBitRates(Poco::UInt32& newUpstreamMaxBitRate, Poco::UInt32& newDownstreamMaxBitRate)
{
	remoting__staticInitBegin(REMOTING__NAMES);
	...
	remoting__staticInitEnd(REMOTING__REPLY_NAME);
	remoting__deser.deserializeMessageBegin(REMOTING__REPLY_NAME, Poco::RemotingNG::SerializerBase::MESSAGE_REPLY);
	Poco::RemotingNG::TypeDeserializer<Poco::UInt32 >::deserialize(REMOTING__NAMES[1], true, remoting__deser, newUpstreamMaxBitRate);
	Poco::RemotingNG::TypeDeserializer<Poco::UInt32 >::deserialize(REMOTING__NAMES[2], true, remoting__deser, newDownstreamMaxBitRate);
	remoting__deser.deserializeMessageEnd(REMOTING__REPLY_NAME, Poco::RemotingNG::SerializerBase::MESSAGE_REPLY);
	remoting__deser.popProperty(Poco::RemotingNG::SerializerBase::PROP_NAMESPACE);
	remoting__trans.endRequest();
}
...
void WANPPPConnectionProxy::getNATRSIPStatus(bool& newRSIPAvailable, bool& newNATEnabled)
{
	remoting__staticInitBegin(REMOTING__NAMES);
...
void WANPPPConnectionProxy::getPPPAuthenticationProtocol(std::string& newPPPAuthenticationProtocol)
{
	remoting__staticInitBegin(REMOTING__NAMES);
	...
	remoting__staticInitEnd(REMOTING__REPLY_NAME);
	remoting__deser.deserializeMessageBegin(REMOTING__REPLY_NAME, Poco::RemotingNG::SerializerBase::MESSAGE_REPLY);
	Poco::RemotingNG::TypeDeserializer<std::string >::deserialize(REMOTING__NAMES[1], true, remoting__deser, newPPPAuthenticationProtocol);
	remoting__deser.deserializeMessageEnd(REMOTING__REPLY_NAME, Poco::RemotingNG::SerializerBase::MESSAGE_REPLY);
	remoting__deser.popProperty(Poco::RemotingNG::SerializerBase::PROP_NAMESPACE);
	remoting__trans.endRequest();
}
...
void WANPPPConnectionProxy::getPPPCompressionProtocol(std::string& newPPPCompressionProtocol)
{
	remoting__staticInitBegin(REMOTING__NAMES);
	...
	remoting__staticInitEnd(REMOTING__REPLY_NAME);
	remoting__deser.deserializeMessageBegin(REMOTING__REPLY_NAME, Poco::RemotingNG::SerializerBase::MESSAGE_REPLY);
	Poco::RemotingNG::TypeDeserializer<std::string >::deserialize(REMOTING__NAMES[1], true, remoting__deser, newPPPCompressionProtocol);
	remoting__deser.deserializeMessageEnd(REMOTING__REPLY_NAME, Poco::RemotingNG::SerializerBase::MESSAGE_REPLY);
	remoting__deser.popProperty(Poco::RemotingNG::SerializerBase::PROP_NAMESPACE);
	remoting__trans.endRequest();
}
...
void WANPPPConnectionProxy::getPPPEncryptionProtocol(std::string& newPPPEncryptionProtocol)
{
	remoting__staticInitBegin(REMOTING__NAMES);
	...
	remoting__staticInitEnd(REMOTING__REPLY_NAME);
	remoting__deser.deserializeMessageBegin(REMOTING__REPLY_NAME, Poco::RemotingNG::SerializerBase::MESSAGE_REPLY);
	Poco::RemotingNG::TypeDeserializer<std::string >::deserialize(REMOTING__NAMES[1], true, remoting__deser, newPPPEncryptionProtocol);
	remoting__deser.deserializeMessageEnd(REMOTING__REPLY_NAME, Poco::RemotingNG::SerializerBase::MESSAGE_REPLY);
	remoting__deser.popProperty(Poco::RemotingNG::SerializerBase::PROP_NAMESPACE);
	remoting__trans.endRequest();
}
...
void WANPPPConnectionProxy::getPassword(std::string& newPassword)
{
	remoting__staticInitBegin(REMOTING__NAMES);
	...
	remoting__staticInitEnd(REMOTING__REPLY_NAME);
	remoting__deser.deserializeMessageBegin(REMOTING__REPLY_NAME, Poco::RemotingNG::SerializerBase::MESSAGE_REPLY);
	Poco::RemotingNG::TypeDeserializer<std::string >::deserialize(REMOTING__NAMES[1], true, remoting__deser, newPassword);
	remoting__deser.deserializeMessageEnd(REMOTING__REPLY_NAME, Poco::RemotingNG::SerializerBase::MESSAGE_REPLY);
	remoting__deser.popProperty(Poco::RemotingNG::SerializerBase::PROP_NAMESPACE);
	remoting__trans.endRequest();
}
...
void WANPPPConnectionProxy::getSpecificPortMappingEntry(const std::string& newRemoteHost, Poco::UInt16 newExternalPort, const std::string& newProtocol, Poco::UInt16& newInternalPort, std::string& newInternalClient, bool& newEnabled, std::string& newPortMappingDescription, Poco::UInt32& newLeaseDuration)
{
	remoting__staticInitBegin(REMOTING__NAMES);
...
void WANPPPConnectionProxy::getStatusInfo(std::string& newConnectionStatus, std::string& newLastConnectionError, Poco::UInt32& newUptime)
{
	remoting__staticInitBegin(REMOTING__NAMES);
...
void WANPPPConnectionProxy::getUserName(std::string& newUserName)
{
	remoting__staticInitBegin(REMOTING__NAMES);
...
void WANPPPConnectionProxy::getWarnDisconnectDelay(Poco::UInt32& newWarnDisconnectDelay)
{
	remoting__staticInitBegin(REMOTING__NAMES);
...
std::string WANPPPConnectionProxy::remoting__enableEvents(Poco::RemotingNG::Listener::Ptr pListener, bool enable)
{
	...
	if ((_pEventListener && !enable) || (!_pEventListener && enable))
	{
		...
		if (pEventListener)
		{
			if (enable)
			{
				...
				_pEventSubscriber = new WANPPPConnectionEventSubscriber(eventURI, this);
...
void WANPPPConnectionProxy::requestConnection()
{
	remoting__staticInitBegin(REMOTING__NAMES);
...
void WANPPPConnectionProxy::requestTermination()
{
	remoting__staticInitBegin(REMOTING__NAMES);
...
void WANPPPConnectionProxy::setAutoDisconnectTime(Poco::UInt32 newAutoDisconnectTime)
{
	remoting__staticInitBegin(REMOTING__NAMES);
...
void WANPPPConnectionProxy::setConnectionType(const std::string& newConnectionType)
{
	remoting__staticInitBegin(REMOTING__NAMES);
...
void WANPPPConnectionProxy::setIdleDisconnectTime(Poco::UInt32 newIdleDisconnectTime)
{
	remoting__staticInitBegin(REMOTING__NAMES);
...
void WANPPPConnectionProxy::setWarnDisconnectDelay(Poco::UInt32 newWarnDisconnectDelay)
{
	remoting__staticInitBegin(REMOTING__NAMES);
...
const std::string WANPPPConnectionProxy::DEFAULT_NS("urn:schemas-upnp-org:service:WANPPPConnection:1");
} // namespace InternetGateway1
} // namespace UPnPS

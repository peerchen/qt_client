...
WANDSLLinkConfigProxy::WANDSLLinkConfigProxy(const Poco::RemotingNG::Identifiable::ObjectId& oid):
...
WANDSLLinkConfigProxy::~WANDSLLinkConfigProxy()
{
	if (_pEventListener)
	{
		try
...
void WANDSLLinkConfigProxy::getATMEncapsulation(std::string& newATMEncapsulation)
{
...
void WANDSLLinkConfigProxy::getAutoConfig(bool& newAutoConfig)
{
	remoting__staticInitBegin(REMOTING__NAMES);
	...
	remoting__staticInitEnd(REMOTING__REPLY_NAME);
	remoting__deser.deserializeMessageBegin(REMOTING__REPLY_NAME, Poco::RemotingNG::SerializerBase::MESSAGE_REPLY);
	Poco::RemotingNG::TypeDeserializer<bool >::deserialize(REMOTING__NAMES[1], true, remoting__deser, newAutoConfig);
	remoting__deser.deserializeMessageEnd(REMOTING__REPLY_NAME, Poco::RemotingNG::SerializerBase::MESSAGE_REPLY);
	remoting__deser.popProperty(Poco::RemotingNG::SerializerBase::PROP_NAMESPACE);
	remoting__trans.endRequest();
}
...
void WANDSLLinkConfigProxy::getDSLLinkInfo(std::string& newLinkType, std::string& newLinkStatus)
{
	remoting__staticInitBegin(REMOTING__NAMES);
	...
	Poco::RemotingNG::TypeDeserializer<std::string >::deserialize(REMOTING__NAMES[2], true, remoting__deser, newLinkStatus);
	remoting__deser.deserializeMessageEnd(REMOTING__REPLY_NAME, Poco::RemotingNG::SerializerBase::MESSAGE_REPLY);
	remoting__deser.popProperty(Poco::RemotingNG::SerializerBase::PROP_NAMESPACE);
	remoting__trans.endRequest();
}
...
void WANDSLLinkConfigProxy::getDestinationAddress(std::string& newDestinationAddress)
{
	remoting__staticInitBegin(REMOTING__NAMES);
...
void WANDSLLinkConfigProxy::getFCSPreserved(bool& newFCSPreserved)
{
	remoting__staticInitBegin(REMOTING__NAMES);
...
void WANDSLLinkConfigProxy::getModulationType(std::string& newModulationType)
{
	remoting__staticInitBegin(REMOTING__NAMES);
	...
	remoting__staticInitEnd(REMOTING__REPLY_NAME);
	remoting__deser.deserializeMessageBegin(REMOTING__REPLY_NAME, Poco::RemotingNG::SerializerBase::MESSAGE_REPLY);
	Poco::RemotingNG::TypeDeserializer<std::string >::deserialize(REMOTING__NAMES[1], true, remoting__deser, newModulationType);
	remoting__deser.deserializeMessageEnd(REMOTING__REPLY_NAME, Poco::RemotingNG::SerializerBase::MESSAGE_REPLY);
	remoting__deser.popProperty(Poco::RemotingNG::SerializerBase::PROP_NAMESPACE);
	remoting__trans.endRequest();
}
...
std::string WANDSLLinkConfigProxy::remoting__enableEvents(Poco::RemotingNG::Listener::Ptr pListener, bool enable)
{
	...
	if ((_pEventListener && !enable) || (!_pEventListener && enable))
	{
		...
		if (pEventListener)
		{
			if (enable)
			{
				...
				_pEventSubscriber = new WANDSLLinkConfigEventSubscriber(eventURI, this);
...
void WANDSLLinkConfigProxy::setATMEncapsulation(const std::string& newATMEncapsulation)
{
	remoting__staticInitBegin(REMOTING__NAMES);
...
void WANDSLLinkConfigProxy::setDSLLinkType(const std::string& newLinkType)
{
	remoting__staticInitBegin(REMOTING__NAMES);
...
void WANDSLLinkConfigProxy::setDestinationAddress(const std::string& newDestinationAddress)
{
	remoting__staticInitBegin(REMOTING__NAMES);
...
void WANDSLLinkConfigProxy::setFCSPreserved(bool newFCSPreserved)
{
	remoting__staticInitBegin(REMOTING__NAMES);
...
const std::string WANDSLLinkConfigProxy::DEFAULT_NS("urn:schemas-upnp-org:service: WANDSLLinkConfig:1");
} // namespace InternetGateway1
} // namespace UPnPS

...
ConnectionManager1Proxy::ConnectionManager1Proxy(const Poco::RemotingNG::Identifiable::ObjectId& oid):
...
ConnectionManager1Proxy::~ConnectionManager1Proxy()
{
	if (_pEventListener)
	{
		try
...
void ConnectionManager1Proxy::connectionComplete(Poco::Int32 connectionID)
{
	...
	Poco::RemotingNG::TypeSerializer<Poco::Int32 >::serialize(REMOTING__NAMES[1], connectionID, remoting__ser);
...
void ConnectionManager1Proxy::getCurrentConnectionIDs(std::string& connectionIDs)
{
	remoting__staticInitBegin(REMOTING__NAMES);
	...
	remoting__staticInitEnd(REMOTING__REPLY_NAME);
	remoting__deser.deserializeMessageBegin(REMOTING__REPLY_NAME, Poco::RemotingNG::SerializerBase::MESSAGE_REPLY);
	Poco::RemotingNG::TypeDeserializer<std::string >::deserialize(REMOTING__NAMES[1], true, remoting__deser, connectionIDs);
	remoting__deser.deserializeMessageEnd(REMOTING__REPLY_NAME, Poco::RemotingNG::SerializerBase::MESSAGE_REPLY);
	remoting__deser.popProperty(Poco::RemotingNG::SerializerBase::PROP_NAMESPACE);
	remoting__trans.endRequest();
}
...
void ConnectionManager1Proxy::getCurrentConnectionInfo(Poco::Int32 connectionID, Poco::Int32& rcsID, Poco::Int32& aVTransportID, std::string& protocolInfo, std::string& peerConnectionManager, Poco::Int32& peerConnectionID, std::string& direction, std::string& status)
{
	remoting__staticInitBegin(REMOTING__NAMES);
	...
	remoting__staticInitEnd(REMOTING__REPLY_NAME);
	remoting__deser.deserializeMessageBegin(REMOTING__REPLY_NAME, Poco::RemotingNG::SerializerBase::MESSAGE_REPLY);
	Poco::RemotingNG::TypeDeserializer<Poco::Int32 >::deserialize(REMOTING__NAMES[2], true, remoting__deser, rcsID);
	Poco::RemotingNG::TypeDeserializer<Poco::Int32 >::deserialize(REMOTING__NAMES[3], true, remoting__deser, aVTransportID);
	Poco::RemotingNG::TypeDeserializer<std::string >::deserialize(REMOTING__NAMES[4], true, remoting__deser, protocolInfo);
	Poco::RemotingNG::TypeDeserializer<std::string >::deserialize(REMOTING__NAMES[5], true, remoting__deser, peerConnectionManager);
	Poco::RemotingNG::TypeDeserializer<Poco::Int32 >::deserialize(REMOTING__NAMES[6], true, remoting__deser, peerConnectionID);
	Poco::RemotingNG::TypeDeserializer<std::string >::deserialize(REMOTING__NAMES[7], true, remoting__deser, direction);
	Poco::RemotingNG::TypeDeserializer<std::string >::deserialize(REMOTING__NAMES[8], true, remoting__deser, status);
	remoting__deser.deserializeMessageEnd(REMOTING__REPLY_NAME, Poco::RemotingNG::SerializerBase::MESSAGE_REPLY);
	remoting__deser.popProperty(Poco::RemotingNG::SerializerBase::PROP_NAMESPACE);
	remoting__trans.endRequest();
}
...
void ConnectionManager1Proxy::getProtocolInfo(std::string& source, std::string& sink)
{
	remoting__staticInitBegin(REMOTING__NAMES);
	...
	Poco::RemotingNG::TypeDeserializer<std::string >::deserialize(REMOTING__NAMES[2], true, remoting__deser, sink);
	remoting__deser.deserializeMessageEnd(REMOTING__REPLY_NAME, Poco::RemotingNG::SerializerBase::MESSAGE_REPLY);
	remoting__deser.popProperty(Poco::RemotingNG::SerializerBase::PROP_NAMESPACE);
	remoting__trans.endRequest();
}
...
void ConnectionManager1Proxy::prepareForConnection(const std::string& remoteProtocolInfo, const std::string& peerConnectionManager, Poco::Int32 peerConnectionID, const std::string& direction, Poco::Int32& connectionID, Poco::Int32& aVTransportID, Poco::Int32& rcsID)
{
	remoting__staticInitBegin(REMOTING__NAMES);
	...
	remoting__ser.pushProperty(Poco::RemotingNG::SerializerBase::PROP_NAMESPACE, remoting__namespace);
	remoting__ser.serializeMessageBegin(REMOTING__NAMES[0], Poco::RemotingNG::SerializerBase::MESSAGE_REQUEST);
	Poco::RemotingNG::TypeSerializer<std::string >::serialize(REMOTING__NAMES[1], remoteProtocolInfo, remoting__ser);
	Poco::RemotingNG::TypeSerializer<std::string >::serialize(REMOTING__NAMES[2], peerConnectionManager, remoting__ser);
	Poco::RemotingNG::TypeSerializer<Poco::Int32 >::serialize(REMOTING__NAMES[3], peerConnectionID, remoting__ser);
	Poco::RemotingNG::TypeSerializer<std::string >::serialize(REMOTING__NAMES[4], direction, remoting__ser);
	remoting__ser.serializeMessageEnd(REMOTING__NAMES[0], Poco::RemotingNG::SerializerBase::MESSAGE_REQUEST);
	remoting__ser.popProperty(Poco::RemotingNG::SerializerBase::PROP_NAMESPACE);
	Poco::RemotingNG::Deserializer& remoting__deser = remoting__trans.sendRequest(remoting__objectId(), remoting__typeId(), REMOTING__NAMES[0], Poco::RemotingNG::SerializerBase::MESSAGE_REQUEST);
	remoting__deser.pushProperty(Poco::RemotingNG::SerializerBase::PROP_NAMESPACE, DEFAULT_NS);
	...
	remoting__staticInitEnd(REMOTING__REPLY_NAME);
	remoting__deser.deserializeMessageBegin(REMOTING__REPLY_NAME, Poco::RemotingNG::SerializerBase::MESSAGE_REPLY);
	Poco::RemotingNG::TypeDeserializer<Poco::Int32 >::deserialize(REMOTING__NAMES[5], true, remoting__deser, connectionID);
	Poco::RemotingNG::TypeDeserializer<Poco::Int32 >::deserialize(REMOTING__NAMES[6], true, remoting__deser, aVTransportID);
	Poco::RemotingNG::TypeDeserializer<Poco::Int32 >::deserialize(REMOTING__NAMES[7], true, remoting__deser, rcsID);
	remoting__deser.deserializeMessageEnd(REMOTING__REPLY_NAME, Poco::RemotingNG::SerializerBase::MESSAGE_REPLY);
	remoting__deser.popProperty(Poco::RemotingNG::SerializerBase::PROP_NAMESPACE);
	remoting__trans.endRequest();
}
...
std::string ConnectionManager1Proxy::remoting__enableEvents(Poco::RemotingNG::Listener::Ptr pListener, bool enable)
{
	...
	if ((_pEventListener && !enable) || (!_pEventListener && enable))
	{
		...
		if (pEventListener)
		{
			if (enable)
			{
				...
				_pEventSubscriber = new ConnectionManager1EventSubscriber(eventURI, this);
...
const std::string ConnectionManager1Proxy::DEFAULT_NS("urn:schemas-upnp-org:service:ConnectionManager:1");
} // namespace MediaServer1
} // namespace UPnPS

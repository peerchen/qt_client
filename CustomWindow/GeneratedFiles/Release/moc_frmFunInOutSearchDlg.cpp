/****************************************************************************
** Meta object code from reading C++ file 'frmFunInOutSearchDlg.h'
**
...
#include "../../Dialog/frmFunInOutSearchDlg.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'frmFunInOutSearchDlg.h' doesn't include <QObject>."
...
struct qt_meta_stringdata_frmFunInOutSearchDlg_t {
    QByteArrayData data[12];
    char stringdata0[227];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_frmFunInOutSearchDlg_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_frmFunInOutSearchDlg_t qt_meta_stringdata_frmFunInOutSearchDlg = {
    {
QT_MOC_LITERAL(0, 0, 20), // "frmFunInOutSearchDlg"
...
QT_MOC_LITERAL(11, 209, 17) // "OnBnClickedOption"
    ...
    "frmFunInOutSearchDlg\0comboBoxNumChanged\0"
...
static const uint qt_meta_data_frmFunInOutSearchDlg[] = {
...
void frmFunInOutSearchDlg::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        frmFunInOutSearchDlg *_t = static_cast<frmFunInOutSearchDlg *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject frmFunInOutSearchDlg::staticMetaObject = {
    { &frmFramelessDialogBase::staticMetaObject, qt_meta_stringdata_frmFunInOutSearchDlg.data,
      qt_meta_data_frmFunInOutSearchDlg,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};


const QMetaObject *frmFunInOutSearchDlg::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *frmFunInOutSearchDlg::qt_metacast(const char *_clname)
{
    if (!_clname) return Q_NULLPTR;
    if (!strcmp(_clname, qt_meta_stringdata_frmFunInOutSearchDlg.stringdata0))
        return static_cast<void*>(const_cast< frmFunInOutSearchDlg*>(this));
    if (!strcmp(_clname, "CHJQueryBase"))
        return static_cast< CHJQueryBase*>(const_cast< frmFunInOutSearchDlg*>(this));
    return frmFramelessDialogBase::qt_metacast(_clname);
}

int frmFunInOutSearchDlg::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{

...
{     
	...
	int Packet2Struct(CBroadcastPacket & pkt) 
	{
		...
		pkt.GetParameterVal("localOrderID", localOrderNo);    // 本地报单号 (not null)
#else
...
#ifdef  YLINK_SYSTEM_ADAPTER
		pkt.GetParameterVal("localOrderID", stBody.localOrderNo);    // 本地报单号 (not null)
#else
...
#ifdef  YLINK_SYSTEM_ADAPTER
		pkt.GetParameterVal("localOrderID", v.localOrderNo);    // 本地报单号 (not null)
#else
		pkt.GetParameterVal("localOrderNo", v.localOrderNo);    // 本地报单号 (not null)
#endif
...
#ifdef  YLINK_SYSTEM_ADAPTER
		pkt.AddParameter("localOrderID", v.localOrderNo);    // 本地报单号 (not null)
#else
...
#ifdef  YLINK_SYSTEM_ADAPTER
		pkt.GetParameterVal("localOrderID", stBody.stBody.localOrderNo);    // 本地报单号 (not null)
#else
...
#ifdef  YLINK_SYSTEM_ADAPTER
		pkt.AddParameter("localOrderID", stBody.stBody.localOrderNo);    // 本地报单号 (not null)
#else

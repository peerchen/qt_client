========================================================================
    ACTIVEX 控件 DLL : SimpleChart 项目概述
========================================================================

控件向导已为 SimpleChart ActiveX 控件 DLL 创建此项目，其中包含一个控件。

此主干项目不仅演示了编写 ActiveX 
控件的基本方法，而且还可以作为编写控件特定功能的起点。

本文件概要介绍组成 SimpleChart ActiveX 控件 DLL 的每个文件的内容。
...
SimpleChartCtrl.h
    此文件包含 CSimpleChartCtrl C++ 类的声明。

SimpleChartCtrl.cpp
    此文件包含 CSimpleChartCtrl C++ 类的实现。

SimpleChartPropPage.h
    此文件包含 CSimpleChartPropPage C++ 类的声明。

SimpleChartPropPage.cpp
    此文件包含 CSimpleChartPropPage C++ 类的实现。

CSimpleChartCtrl.bmp
    此文件包含一个位图，当 CSimpleChartCtrl 
...
stdAfx.h，stdAfx.cpp
    这些文件用于生成名为 SimpleChart.pch 的预编译头 (PCH) 文件和名为 

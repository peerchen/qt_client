...
#	define SYSBK_BOURSE			 0x0400 // 港股板块(H股指数成份股，红色K线指数成份股）。
#	define USERDEF_BOURSE		 0x0800 // 自定义（自选股或者自定义板块）
...
#		define WP_INDEX_RJ	 		0x0001 //"日经";
#		define WP_INDEX_HZ	 		0x0002 //"恒指";
#		define WP_INDEX_NH	 		0x0003 //"南韩综合";
#		define WP_INDEX_TG	 		0x0004 //"台股加权";
#		define WP_INDEX_XG	 		0x0005 //"星股海峡";
#		define WP_INDEX_MG	 		0x0006 //"马股综合";
#		define WP_INDEX_TGZH 		0x0007 //"泰股综合";
#		define WP_INDEX_YN 		    0x0008 //"印尼综合";
#		define WP_INDEX_AZ 		    0x0009 //"澳洲综合";
#		define WP_INDEX_NXL  		0x000a //"纽西兰";
#		define WP_INDEX_SGX         0x000b //"SGX摩台";
#		define WP_INDEX_SENSEX      0x000c //"印SENSEX";
#		define WP_INDEX_KOSPI       0x000d //"KOSPI200";
#		define WP_INDEX_DQGY        0x000e //"道琼工业";
#		define WP_INDEX_DQYS        0x000f //"道琼运输";
#		define WP_INDEX_DQGG        0x0010 //"道琼公共";
#		define WP_INDEX_NSDK        0x0011 //"纳斯达克"
#		define WP_INDEX_BZPE        0x0012 //"标准普尔"
#		define WP_INDEX_CRBYX       0x0013 //"CRB延续"
#		define WP_INDEX_CRBZS       0x0014 //"CRB指数"
#		define WP_INDEX_JND         0x0015 //"加拿大"
#		define WP_INDEX_FS100       0x0016 //"富时100"
#		define WP_INDEX_FACAC       0x0017 //"法CAC40"
#		define WP_INDEX_DEDAX       0x0018 //"德DAX"
#		define WP_INDEX_HEAEX       0x0019 //"荷兰AEX"
#		define WP_INDEX_DMKFX       0x001a //"丹麦KFX"
#		define WP_INDEX_BLS         0x001b //"比利时"
#		define WP_INDEX_RSSSMI      0x001c //"瑞士SSMI"
#		define WP_INDEX_BXBVSP      0x001d //"巴西BVSP"
#		define WP_INDEX_BDI         0x001e //"BDI指数"
#		define WP_INDEX_BP100       0x001f //"标普100"
#		define WP_INDEX_ERTS        0x0020 //"俄RTS"
#		define WP_INDEX_YFTMIB      0x0021 //"意FTMIB"
...
#	define HJ_SH_CURR			0x0100	// 上海金交所
...
#define STOCK_CODE_SIZE		6			// 股票名称长度
// 股票代码结构
struct CodeInfo
{
...
struct StockUserInfo
{
	...
	virtual void Copy(StockUserInfo* pStock)
	{
		if( pStock )
		{
			...
			strncpy(m_cStockName,pStock->m_cStockName,sizeof(m_cStockName)) ;	    //股票名称
			strncpy(m_cStockPYJC,pStock->m_cStockPYJC,sizeof(m_cStockPYJC)) ;	    //拼音简称

...
#define CEV_Connect_WP			   HS_LANGUAGE("外盘") // 外盘
	...
	*/
	...
	char GetAutoAddLogin()
	{
		return (m_cHQAutoAddLogin + m_cQHAutoAddLogin +
				...
				m_cGGAutoAddLogin + m_cWPAutoAddLogin);
	}
...
#define YLS_HANDSOMETRANSTYPE_		0x0002//254
#define YLS_HANDSOMESOURCETRANS_	0x0004//255
#define YLS_CURTYPE					0x0008//10

#define YLS_NotSendPacketTest		0x0100//不发送数据包，测试通讯
#define YLS_DFXComm					0x0200//1.5dfx通讯
...
#define YLS_OPEN_SetProxy   0x0010      // 新华社代理设置 yangdl 2008.09.04     
